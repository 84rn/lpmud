...
create_spells()
{
    ustaw_nazwe( ({ "ksiega", "ksiegi", "ksiedze", "ksiega", "ksiega",
        "ksiedze" }), ({ "ksiegi", "ksiag", "ksiegom", "ksiegi", 
        "ksiegami", "ksiegach" }), PL_ZENSKI);
    set_long("Ciezka ksiega, z napisem 'Magica Arcana' na okladce.\n");
}
