...
# defined in config.h !
MUD_LIB = /home/arkadia/public-dist/lib

# Set BINDIR to the directory where you want to install the executables.
BINDIR = /home/arkadia/public-dist/bin
...
# Select from: drand48.[co], strerror.[co], strpbrk.[co], strtod.[co],
#              snprintf.[co], vprintf.[co]
...
SYS_OPT=-O2 -fomit-frame-pointer
SYS_LIBS=-lcrypt
CC=/usr/bin/gcc
ULIBS=
LINTFILTER=sedf.sun

# BSD/OS 2.x, 3.x and 4.x
#SYS_CFLAGS=-pipe
#SYS_OPT=-g -O2
#SYS_LIBS=
#CC=gcc
